#define HANDLE_ACTION(action, handlePass) \
  switch (action) {  \
    ...
    case LlvmAction::ANNOTATION_REMARKS: \
      handlePass(llvm::createAnnotationRemarksLegacy()); \
      break; \
    ...
    case LlvmAction::BDCE: \
      ...
      break; \
    case LlvmAction::EXTRACT_BLOCKS: \
      handlePass(llvm::createBlockExtractorLegacyPass()); \
      break; \
    ...
    case LlvmAction::CONSTRAINT_ELIMINATION: \
      handlePass(llvm::createConstraintElimination()); \
      break; \
    ...
    case LlvmAction::DFSAN: \
      handlePass(llvm::createDataFlowSanitizerLegacyPass()); \
      break; \
    ...
    case LlvmAction::FUNCTION_SPECIALIZATION: \
      handlePass(llvm::createFunctionSpecializationLegacyPass()); \
      break; \
    ...
    case LlvmAction::MEMCPYOPT: \
      ...
      break; \
    case LlvmAction::MEMPROF: \
      handlePass(llvm::createMemProfilerLegacyPass()); \
      break; \
    ...
    case LlvmAction::MLDST_MOTION: \
      ...
      break; \
    case LlvmAction::MEMPROF_MODULE: \
      handlePass(llvm::createModuleMemProfilerLegacyPass()); \
      break; \
    ...
    case LlvmAction::OBJC_ARC_CONTRACT: \
      ...
      break; \
    case LlvmAction::OBJC_ARC: \
      handlePass(llvm::createObjCARCOptLegacyPass()); \
      break; \
